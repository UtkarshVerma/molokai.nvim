...
return {
    ...
    CursorColumn = { bg = c.bg_float }, -- Screen-column at the cursor, when 'cursorcolumn' is set.
    CursorLine   = { bg = c.bg_float }, -- Screen-line at the cursor, when 'cursorline' is set.  Low-priority if foreground (ctermfg OR guifg) is not set.
    ...
    PmenuSbar    = { bg = c.bg_gray }, -- Popup menu: scrollbar.
    PmenuThumb   = { bg = c.fg_alt }, -- Popup menu: Thumb of the scrollbar.
